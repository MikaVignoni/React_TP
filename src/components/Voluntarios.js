...
const Voluntarios = () => {
  return (
    <div className="Voluntarios"> 
      ...
      <p>En Huellitas cada vida importa y cada gesto de ayuda cuenta. Siempre hay espacio para más manos y corazones solidarios. Hay muchas formas de colaborar y toda la ayuda es bienvenida con los brazos abiertos. </p>
